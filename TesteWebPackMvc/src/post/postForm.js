...
function closeModal() {
    const overlayModal = document.querySelector('.modal-backdrop');
...
const ListarPosts = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (posts) {
        ...
        const liButtons = document.querySelectorAll('.round-button');
...
const savePost = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result.success) {
        carregando(true);
        if (postId === 0) {
            yield postService_1.postPost(result.data);
        }
        else {
